...
public record Edge<V>(V vertex1, V vertex2) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!res && obj instanceof Edge<?> that) {
            res = (vertex1.equals(that.vertex1) && vertex2.equals(that.vertex2))
                    || (vertex2.equals(that.vertex1) && vertex1.equals(that.vertex2));
        }
        return res;
    }
    ...
    public String toString() {
        return getClass().getSimpleName() + "(" + vertex1 +", " + vertex2 + ")";
    }
}