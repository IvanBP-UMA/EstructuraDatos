...
int main(void)
{
    ...
    printf("Hash persona 1 %i\n", hashFunc(persona1->id, tablaHash->capacidad));
    insertar(tablaHash, persona1);
    printf("Hash persona 2 %i\n", hashFunc(persona2->id, tablaHash->capacidad));
    insertar(tablaHash, persona2);
    printf("Hash persona 3 %i\n", hashFunc(persona3->id, tablaHash->capacidad));
    insertar(tablaHash, persona3);
    printf("Hash persona 4 %i\n", hashFunc(persona4->id, tablaHash->capacidad));
    insertar(tablaHash, persona4);
    printf("Hash persona 5 %i\n", hashFunc(persona5->id, tablaHash->capacidad));
    insertar(tablaHash, persona5);
    printf("Hash persona 6 %i\n", hashFunc(persona6->id, tablaHash->capacidad));
    insertar(tablaHash, persona6);
    printf("Hash persona 7 %i\n", hashFunc(persona7->id, tablaHash->capacidad));
    insertar(tablaHash, persona7);

    printf("Hash persona 8 %i\n", hashFunc(persona8->id, tablaHash->capacidad));
    ...
    printf("Hash persona 13 %i\n", hashFunc(persona13->id, tablaHash->capacidad));
    insertar(tablaHash, persona13);
    
    printf("Hash persona 14 %i\n", hashFunc(persona14->id, tablaHash->capacidad));
    insertar(tablaHash, persona14);

    printf("Hash persona 21 %i\n", hashFunc(persona21->id, tablaHash->capacidad));
